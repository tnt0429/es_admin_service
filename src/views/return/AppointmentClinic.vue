        ...
        <el-row>
            <el-form ref="#" :model="formQuery" label-width="5rem" :inline="true" size="small">
                ...
                <el-form-item label="门诊时间">
                    <el-date-picker v-model="formQuery.clinicDate" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"/>
                </el-form-item>
                <el-form-item>
            ...
            <el-card shadow="hover">
                <el-table :data="tableData" stripe style="width: 100%">
                    ...
                    <el-table-column prop="returnTime" label="门诊时间"/>
                    <el-table-column prop="returnMan" label="信息记录人"/>

...
<template>
    ...
    >
        <el-row slot="title">
            <el-col :span="12">
                <span style="color: #777777; font-size: 18px;font-weight:bold;">患者信息采集</span>
            </el-col>
            ...
            <el-tabs type="border-card">
                <el-tab-pane label="门诊信息">
                    <el-row>
                        ...
                        <el-col :span="4">
                            <el-form-item label="证件号码" prop="patientsCard">
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="住院科室" prop="inpatientDepartment">
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="出院时间" prop="dischargeDate">
                                <el-input v-model="dataFrom.dischargeDate" placeholder="日期选择框"/>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="住院天数" prop="hospitalDay">
                                <el-input v-model="dataFrom.hospitalDay" placeholder="自动算出，不可修改"/>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="入院疼痛评分" prop="hospitalPainScore">
                                <el-input v-model="dataFrom.hospitalPainScore" placeholder="数值，取值0-10"/>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="出院疼痛评分" prop="dischargePainScore">

    ...
    <div>
        ...
        <el-row>
            <el-form ref="#" :model="formQuery" label-width="5rem" :inline="true" size="small">
                ...
                <el-form-item label="诊断内容" label-width="7rem">
                    <el-input v-model="formQuery.dicName" placeholder="请输入诊断内容"/>
                </el-form-item>
            ...
            <el-card shadow="hover">
                <el-table :data="tableData" stripe style="width: 100%">
                    ...
                    <el-table-column prop="dicName" label="诊断内容"/>
...
<script>
    ...
    import dicDiagnosisList from "../../api/dicDiagnosisList.ts"

...
<template>
    <div>
        <el-row style="margin: 0.5rem;">
            <el-alert title="同评估模板疑问，维护后由谁在何处使用。" type="error" effect="dark"/>
        ...
        <el-row>
            <el-form ref="#" :model="formQuery" label-width="5rem" :inline="true" size="small">
                ...
                <el-form-item label="评估结论" label-width="7rem">
                    <el-input v-model="formQuery.dicName" placeholder="请输入评估结论"/>
                </el-form-item>
            ...
            <el-card shadow="hover">
                <el-table :data="tableData" stripe style="width: 100%">
                    ...
                    <el-table-column prop="dicName" label="评估结论"/>
